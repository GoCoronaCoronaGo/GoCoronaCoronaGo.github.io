...
function toggleLoading(isLoading) {
  ...
  if(isLoading === true)
  {
    ...
    image.id = "searchImg";
    image.className = "fas fa-hourglass-half";
    let txtNode = document.createTextNode(" Loading…");
  ...
  else
  {
    ...
    let image = document.createElement("i");
    image.id = "searchImg";
    image.className = "fas fa-search";
    let txtNode = document.createTextNode(" Search");
    btn.appendChild(image);
    btn.appendChild(txtNode);
    btn.disabled = false;
  }
